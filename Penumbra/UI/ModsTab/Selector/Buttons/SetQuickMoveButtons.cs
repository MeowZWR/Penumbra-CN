...
public sealed class SetQuickMoveFoldersButtons(ModFileSystemDrawer drawer) : BaseButton<IFileSystemFolder>
{
    ...
    public override bool DrawMenuItem(in IFileSystemFolder data)
    {
        ...
        Im.Tooltip.OnHover(drawer.Config.QuickMoveFolder1.Length is 0 ? "设置这个折叠组为快速移动的目标位置。"u8 : $"设置这个折叠组为快速移动的目标位置而不是 {drawer.Config.QuickMoveFolder1}。");
        ...
        Im.Tooltip.OnHover(drawer.Config.QuickMoveFolder2.Length is 0 ? "设置这个折叠组为快速移动的目标位置。"u8 : $"设置这个折叠组为快速移动的目标位置而不是 {drawer.Config.QuickMoveFolder2}。");
        ...
        Im.Tooltip.OnHover(drawer.Config.QuickMoveFolder3.Length is 0 ? "设置这个折叠组为快速移动的目标位置。"u8 : $"设置这个折叠组为快速移动的目标位置而不是 {drawer.Config.QuickMoveFolder3}。");
        return false;
    }
}
