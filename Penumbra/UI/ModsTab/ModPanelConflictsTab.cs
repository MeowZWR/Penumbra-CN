...
public class ModPanelConflictsTab(CollectionManager collectionManager, ModSelection selection) : ITab<ModPanelTab>
{
    ...
    public void DrawContent()
    {
        ...
        table.SetupColumn("优先级"u8,        TableColumnFlags.WidthFixed, priorityRowWidth);
        table.SetupColumn("文件"u8,           TableColumnFlags.WidthFixed, Im.Font.CalculateSize("文件"u8).X + spacing.X);
