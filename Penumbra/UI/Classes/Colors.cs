...
public static class Colors
{
    ...
    private const string OptionColorTooltip =
        "用于模组选项的可选文本或标签的颜色。模组作者可以从这 8 种颜色中选择一种（或选择无以使用默认文本），但你可以自行决定实际显示的颜色。";
    ...
    public static (uint DefaultColor, string Name, string Description) Data(this ColorId color)
        => color switch
        {
            ...
            ColorId.OptionColor1                  => (0xFFF8CD8E, "模组选项可选颜色 #1",                          OptionColorTooltip),
            ColorId.OptionColor2                  => (0xFFAAD898, "模组选项可选颜色 #2",                          OptionColorTooltip),
            ColorId.OptionColor3                  => (0xFF8AD1E6, "模组选项可选颜色 #3",                          OptionColorTooltip),
            ColorId.OptionColor4                  => (0xFF6B8CD9, "模组选项可选颜色 #4",                          OptionColorTooltip),
            ColorId.OptionColor5                  => (0xFFA38FD9, "模组选项可选颜色 #5",                          OptionColorTooltip),
            ColorId.OptionColor6                  => (0xFFDB9DB3, "模组选项可选颜色 #6",                          OptionColorTooltip),
            ColorId.OptionColor7                  => (0xFF6A5CC7, "模组选项可选颜色 #7",                          OptionColorTooltip),
            ColorId.OptionColor8                  => (0xFF6BB5A6, "模组选项可选颜色 #8",                          OptionColorTooltip),
            ColorId.GroupSeparatorExpanded        => (0x80806E6E, "选项组分隔线与边框（展开）",                   "选项组展开时，组的分隔线与边框颜色。"),
            ColorId.GroupSeparatorCollapsed       => (0x80806E6E, "选项组分隔线与边框（折叠）",                   "选项组折叠时，组的分隔线与边框颜色。"),
            ColorId.GroupLabelTextExpanded        => (0xFFFFFFFF, "选项组标签（展开）",                           "选项组展开时，组标签文本的颜色。"),
            ColorId.GroupLabelTextCollapsed       => (0xFFA0A0A0, "选项组标签（折叠）",                           "选项组折叠时，组标签文本的颜色。"),
            ColorId.GroupComboBackground          => (0x8A4A4A4A, "选项组下拉预览背景",                           "单选组下拉预览的背景颜色。"),
            ColorId.GroupFrameBackgroundExpanded  => (0x8A4A4A4A, "选项组边框背景（展开）",                       "选项组展开时，组标签边框的背景颜色。"),
            ColorId.GroupFrameBackgroundCollapsed => (0x8A4A4A4A, "选项组边框背景（折叠）",                       "选项组折叠时，组标签边框的背景颜色。"),
