...
public partial class MaterialEditor
{
    ...
    private static void DrawLegacyColorTableHeader(in Im.TableDisposable table, bool hasDyeTable)
    {
        ...
        table.Header("平铺"u8);
        table.NextColumn();
        table.Header("重复/偏斜"u8);
        if (hasDyeTable)
        {
            table.NextColumn();
            table.Header("染色"u8);
            table.NextColumn();
            table.Header("染色预览"u8);
        }
    }
    ...
    private bool DrawLegacyColorTableRow(LegacyColorTable table, LegacyColorDyeTable? dyeTable, int rowIdx, bool disabled)
    {
        ...
        Im.Table.NextColumn();
        ret |= CtColorPicker("##Emissive"u8, "发光颜色"u8, row.EmissiveColor,
            c => table[rowIdx].EmissiveColor = c);
        if (dyeTable != null)
        {
            Im.Line.SameInner();
            ret |= CtApplyStainCheckbox("##dyeEmissive"u8, "在染色上应用发光颜色"u8, dye.EmissiveColor,
        ...
        if (dyeTable is not null)
        {
            ...
            Im.Tooltip.OnHover("染色模板"u8, HoveredFlags.AllowWhenDisabled);
    ...
    private bool DrawLegacyColorTableRow(ColorTable table, ColorDyeTable? dyeTable, int rowIdx, bool disabled)
    {
        ...
        {
            Im.Line.SameInner();
            ret |= CtApplyStainCheckbox("##dyeShininess"u8, "在染色上应用光泽强度"u8, dye.Exposure,
        ...
        Im.Line.SameInner();
        Im.Item.SetNextWidth(pctSize);
        ret |= CtDragScalar("##TileAlpha"u8, "平铺透明度"u8, (float)row.TileAlpha * 100.0f, "%.0f%%"u8, 0f, HalfMaxValue * 100.0f, 1.0f,
        ...
        if (dyeTable is not null)
        {
            ...
            ret |= CtDragScalar("##DyeChannel"u8, "染色通道"u8, dye.Channel + 1, "%hhd"u8, 1, StainService.ChannelCount, 0.1f,
    ...
    private bool DrawLegacyDyePreview(int rowIdx, bool disabled, LegacyColorDyeTableRow dye, float floatSize)
    {
        ...
        var ret = ImEx.Icon.Button(LunaStyle.DyeIcon, "将选定的染料应用于此行。"u8, disabled);
