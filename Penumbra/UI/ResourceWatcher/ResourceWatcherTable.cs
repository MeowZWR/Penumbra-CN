...
internal sealed class ResourceWatcherTable : TableBase<CachedRecord, TableCache<CachedRecord>>
{
    ...
    public ResourceWatcherTable(FilterConfig filterConfig, IReadOnlyList<Record> records)
        : base(new StringU8("##records"u8),
            new PathColumn(filterConfig) { Label             = new StringU8("路径"u8) },
            new RecordTypeColumn(filterConfig) { Label       = new StringU8("记录"u8) },
            new CollectionColumn(filterConfig) { Label       = new StringU8("合集"u8) },
            new ObjectColumn(filterConfig) { Label           = new StringU8("游戏对象"u8) },
            new CustomLoadColumn(filterConfig) { Label       = new StringU8("自定义"u8) },
            new SynchronousLoadColumn(filterConfig) { Label  = new StringU8("同步"u8) },
            new OriginalPathColumn(filterConfig) { Label     = new StringU8("原始路径"u8) },
            new ResourceCategoryColumn(filterConfig) { Label = new StringU8("类型"u8) },
            new ResourceTypeColumn(filterConfig) { Label     = new StringU8("格式"u8) },
            new HandleColumn(filterConfig) { Label           = new StringU8("资源"u8) },
            new LoadStateColumn(filterConfig) { Label        = new StringU8("状态"u8) },
            new RefCountColumn(filterConfig) { Label         = new StringU8("#Ref"u8) },
            new DateColumn { Label                           = new StringU8("时间"u8) },
            new Crc64Column(filterConfig) { Label            = new StringU8("Crc64"u8) },
            new OsThreadColumn(filterConfig) { Label         = new StringU8("线程ID"u8) }
        )
        => _records = records;
