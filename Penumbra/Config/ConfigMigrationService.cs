...
#pragma warning restore CA1869
    ...
    private void MigrateToNewFiles(in JsonElement json, int version)
    {
        ...
        config.Ui.ShowModPreviewPanel      = json.PropertyOrDefault("ShowModPreviewPanel"u8,      config.Ui.ShowModPreviewPanel);
        config.Ui.SavePreviewPanelState    = json.PropertyOrDefault("SavePreviewPanelState"u8,    config.Ui.SavePreviewPanelState);
        config.Ui.PreviewPanelRatio        = json.PropertyOrDefault("PreviewPanelRatio"u8,        config.Ui.PreviewPanelRatio);
        config.Ui.PreviewPanelMinWidth     = json.PropertyOrDefault("PreviewPanelMinWidth"u8,     config.Ui.PreviewPanelMinWidth);
        config.Ui.PreviewPanelMaxWidth     = json.PropertyOrDefault("PreviewPanelMaxWidth"u8,     config.Ui.PreviewPanelMaxWidth);
        config.Ui.PreviewImageMinWidth     = json.PropertyOrDefault("PreviewImageMinWidth"u8,     config.Ui.PreviewImageMinWidth);
        config.Ui.PreviewPanelImageSpacing = json.PropertyOrDefault("PreviewPanelImageSpacing"u8, config.Ui.PreviewPanelImageSpacing);
        config.Ui.PreviewPanelMaxMemory    = json.PropertyOrDefault("PreviewPanelMaxMemory"u8,    config.Ui.PreviewPanelMaxMemory);
        ...
        config.Editing.HideDdsFiles  = json.PropertyOrDefault("HideDdsFiles"u8,  config.Editing.HideDdsFiles);
        config.Editing.HidePngFiles  = json.PropertyOrDefault("HidePngFiles"u8,  config.Editing.HidePngFiles);
        config.Editing.HideJpegFiles = json.PropertyOrDefault("HideJpegFiles"u8, config.Editing.HideJpegFiles);
        config.Editing.HideJsonFiles = json.PropertyOrDefault("HideJsonFiles"u8, config.Editing.HideJsonFiles);
        config.Editing.HideTgaFiles  = json.PropertyOrDefault("HideTgaFiles"u8,  config.Editing.HideTgaFiles);
        config.Editing.HideBmpFiles  = json.PropertyOrDefault("HideBmpFiles"u8,  config.Editing.HideBmpFiles);
        config.Editing.HideGifFiles  = json.PropertyOrDefault("HideGifFiles"u8,  config.Editing.HideGifFiles);
        config.Editing.HideTiffFiles = json.PropertyOrDefault("HideTiffFiles"u8, config.Editing.HideTiffFiles);
        config.Editing.HideWebpFiles = json.PropertyOrDefault("HideWebpFiles"u8, config.Editing.HideWebpFiles);
        config.Editing.HideXcpFiles  = json.PropertyOrDefault("HideXcpFiles"u8,  config.Editing.HideXcpFiles);
    }
