...
public sealed partial class UiConfig : ConfigurationFile<FilenameService>
{
    ...
    [ConfigProperty]
    private bool _showModPreviewPanel = false;

    [ConfigProperty]
    private bool _savePreviewPanelState = true;

    [ConfigProperty]
    private float _previewPanelRatio = 0.4f;

    [ConfigProperty]
    private float _previewPanelMinWidth = 200f;

    [ConfigProperty]
    private float _previewPanelMaxWidth = 600f;

    [ConfigProperty]
    private float _previewImageMinWidth = 180f;

    [ConfigProperty]
    private float _previewPanelImageSpacing = 4f;

    [ConfigProperty]
    private long _previewPanelMaxMemory = 256L * 1024L * 1024L;
    ...
    protected override void AddData(Utf8JsonWriter j)
    {
        ...
        {
            tempObject.WriteIfNot("ShowModPreviewPanel"u8,      ShowModPreviewPanel,      false);
            tempObject.WriteIfNot("SavePreviewPanelState"u8,    SavePreviewPanelState,    true);
            tempObject.WriteIfNot("PreviewPanelRatio"u8,        PreviewPanelRatio,        0.4f);
            tempObject.WriteIfNot("PreviewPanelMinWidth"u8,     PreviewPanelMinWidth,     200f);
            tempObject.WriteIfNot("PreviewPanelMaxWidth"u8,     PreviewPanelMaxWidth,     600f);
            tempObject.WriteIfNot("PreviewImageMinWidth"u8,     PreviewImageMinWidth,     180f);
            tempObject.WriteIfNot("PreviewPanelImageSpacing"u8, PreviewPanelImageSpacing, 4f);
            tempObject.WriteIfNot("PreviewPanelMaxMemory"u8,    PreviewPanelMaxMemory,    256L * 1024L * 1024L);
        }
    ...
    protected override void LoadData(in JsonElement j)
    {
        ...
        {
            ShowModPreviewPanel      = previewPanel.PropertyOrDefault("ShowModPreviewPanel"u8,      ShowModPreviewPanel);
            SavePreviewPanelState    = previewPanel.PropertyOrDefault("SavePreviewPanelState"u8,    SavePreviewPanelState);
            PreviewPanelRatio        = previewPanel.PropertyOrDefault("PreviewPanelRatio"u8,        PreviewPanelRatio);
            PreviewPanelMinWidth     = previewPanel.PropertyOrDefault("PreviewPanelMinWidth"u8,     PreviewPanelMinWidth);
            PreviewPanelMaxWidth     = previewPanel.PropertyOrDefault("PreviewPanelMaxWidth"u8,     PreviewPanelMaxWidth);
            PreviewImageMinWidth     = previewPanel.PropertyOrDefault("PreviewImageMinWidth"u8,     PreviewImageMinWidth);
            PreviewPanelImageSpacing = previewPanel.PropertyOrDefault("PreviewPanelImageSpacing"u8, PreviewPanelImageSpacing);
            PreviewPanelMaxMemory    = previewPanel.PropertyOrDefault("PreviewPanelMaxMemory"u8,    PreviewPanelMaxMemory);
        }
